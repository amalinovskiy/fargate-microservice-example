# Assume role for infrastructure creation
aws sts assume-role --role-arn "arn:aws:iam::$1:role/OrganizationAccountAccessRole" --role-session-name BoostrapSession > .aws_session
